      ...
      <ScrollView className='flex-1 bg-background pt-6 px-4'>
        ...
        <View className='bg-primary/5 p-4 rounded-xl mb-3'>
          <View className='flex-row items-center gap-4'>
            ...
            <View className='flex-1'>
              <Text className='text-quaternary text-2xl font-bold'>John Doe</Text>
              <Text className='text-md text-gray-400'>Web3 Domain Enthusiast</Text>
        ...
        <View className='flex-row gap-3 mb-3'>
          ...
          <View className='flex-1 bg-primary/5 p-4 rounded-xl'>
            <Text className='text-quaternary text-lg font-semibold mb-2'>Portfolio Value</Text>
        ...
        <View className='bg-primary/5 p-4 rounded-xl mb-3'>
          <Text className='text-quaternary text-lg font-semibold mb-3'>Featured Domains</Text>
        ...
        <View className='flex-row gap-3 mb-3'>
          ...
          <View className='flex-1 bg-primary/5 p-4 rounded-xl'>
            <Text className='text-quaternary text-lg font-semibold mb-3'>Top Sale</Text>
          ...
          <View className='flex-1 bg-primary/5 p-4 rounded-xl'>
            <Text className='text-quaternary text-lg font-semibold mb-3'>Trading History</Text>
            <View className='p-3 rounded-lg'>
              ...
              <View className='flex-row items-center justify-between'>
                <Text className='text-tertiary text-sm'>+25% from last month</Text>
                <AntDesign name="arrowup" size={12} color="#22c55e" />
              </View>
            </View>
          </View>
        ...
        <View className='bg-primary/5 p-4 rounded-xl'>
          <View className='flex-row justify-between items-center mb-3'>
            <Text className='text-quaternary text-lg font-semibold'>Watching</Text>
